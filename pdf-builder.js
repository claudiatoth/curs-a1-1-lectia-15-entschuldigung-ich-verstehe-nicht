// PDF BUILDER — Andreeas Tag (A1.1 · Lecția 3)
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Strategii de conversație + Wiederholung Präsens</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillInBlock('Übung 1 — Cele 4 întrebări de bază când nu înțelegi', '„Was ist das?" (Ce e asta?) · „Wie heißt das?" (Cum se cheamă?) · „Was bedeutet X?" (Ce înseamnă X?) · „Wie schreibt man X?" (Cum se scrie X?).', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += fillInBlock('Übung 2 — „Was bedeutet ...?" + „Wie bitte?" (formule de lămurire)', '„bedeuten" = a însemna. „Wie bitte?" = Cum ați spus? · „Können Sie das wiederholen?" = Puteți repeta?', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — Verbele separabile recap (vorbereiten, anrufen, umziehen)', 'Verbele separabile pe care le-am întâlnit: vorbereiten (a pregăti), anrufen (a telefona), umziehen (a se muta), anziehen (a îmbrăca), aufstehen, einkaufen...', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillInBlock('Übung 4 — Wiederholung Präsens: conjugare verbe regulate + tari', 'Recap din L3-L10: schwache (spielen, lernen) · starke cu Vokalwechsel (lesen, nehmen, fahren) · modale (können, müssen).', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += fillInBlock('Übung 5 — Dialog real: cere lămuriri natural', 'Pattern: când Annette/Florian zice un cuvânt necunoscut, întrebi: „Entschuldigung, was bedeutet X?" sau „Wie schreibt man das?".', ex5Data);
        }
        return html;
    }
